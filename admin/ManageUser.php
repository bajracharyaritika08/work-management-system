        ...
        ?>
            <div class="flex-container">
                  <div class="flex-item-left">
                        ...
                        <p>Modify User</p><br>
                        <a href="EditUser.php?id=<?php echo $data ['reg_id']; ?>"><button style="background-color:#106399;padding:10px 15px;border-radius:5px;color:white; cursor: pointer;">View User Details</button></a>
                    <a href="deleteusers.php/?reg_id=<?php echo $data ['reg_id'];?>"><button style="background-color:#630700;padding:10px 18px;border-radius:5px;color:white; cursor: pointer;">Delete User</button></a>
