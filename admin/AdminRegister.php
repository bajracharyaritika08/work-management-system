...
if(isset($_POST['submit'])){
    ...
    $create_query="INSERT INTO `admins`( `fullname`, `gender`,  `teamleader`, `email`, `username`, `passwords`) VALUES('$fullname','$gender', '$teamleader','$email', '$username', '$passwords')";
    ...
    if($create_result){
        ...
        ?>
        <button class="newuser"><a href="ManageAdmin.php">View Admin.</a></button>
        <?php
    }
    else{
...
?> 
                <button class="newuser"><a href="ManageAdmin.php">Back</a></button>
